...
var trackfunnelMixpanelEvent = function(){
    ...
    switch (MP_LOAD_TYPE) {
        case "async":
            mpq.push(["track_funnel", funnel_name, funnel_step, funnel_goal, funnel_data]);
            break
        case "standard":
            mpmetrics.track_funnel(funnel_name, funnel_step, funnel_goal, funnel_data, funnel_callback);
            break
        case "fbml":
            mpmetrics.track_funnel(funnel_name, funnel_step, funnel_goal, funnel_data);
            break
        default:
            throw "mixpanel type error"
    }
